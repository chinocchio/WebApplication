...
namespace WebApplication2.Migrations
{
    ...
    [Migration("20250522082244_AddedInfo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication2.Models.BusinessPartner", b =>
                {
                    ...
                    b.Property<string>("DemographicByMarket")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("EmploymentCountry")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("EmploymentRegion")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebApplication2.Models.DocumentForSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DocumentFinanceType")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("DocumentSourceOfIncome")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("DocumentForSubmissions");
                });

            modelBuilder.Entity("WebApplication2.Models.DocumentRegistry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication2.Models.PaymentTerm", b =>
                {
                    ...
                    b.Property<double?>("AmountPaidToTF")
                        .HasColumnType("float");

                    b.Property<double?>("AmountPaidToUnit")
                        .HasColumnType("float");

                    b.Property<DateOnly?>("DatePaid")
                        .HasColumnType("date");

                    b.Property<double?>("EstimatedBankMAFor7Point5Percent")
                        .HasColumnType("float");

                    b.Property<string>("FirstMAOrNumber")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PercentPayment")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PercentTOB")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateOnly?>("StartDate1stMA")
                        .HasColumnType("date");

                    b.Property<double?>("TFee")
                        .HasColumnType("float");

                    b.Property<double?>("TOB")
                        .HasColumnType("float");

                    b.Property<string>("TOBModeOfPayment")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebApplication2.Models.SalesProponent", b =>
                {
                    ...
                    b.Property<long>("ProponentBpNumber")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("WebApplication2.Models.SubmittedDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication2.Models.SalesTransaction", b =>
                {
                    ...
                    b.HasOne("WebApplication2.Models.PaymentTerm", "PaymentTerm")
                        .WithMany("SalesTransaction")
